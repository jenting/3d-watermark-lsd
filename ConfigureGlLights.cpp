...
ConfigureGlLights::ConfigureGlLights(QWidget* parent, const char* name, Qt::WFlags flags):
...
void ConfigureGlLights::LoadConfiguration( int num )
{
	...
	for (int i=0;i<8;i++) {
		QString lightString = qs.readEntry("light_"+QString::number(i), "", &configExists);
